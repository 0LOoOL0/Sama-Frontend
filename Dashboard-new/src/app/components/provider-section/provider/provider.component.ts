...
import { ProviderStepsComponent } from '../provider-steps/provider-steps.component';
@Component({
  selector: 'app-provider',
  imports: [CommonModule/*, ProviderHeaderComponent*/, ProviderProfileComponent, RouterOutlet, RouterLinkActive, RouterLink, ProviderStepsComponent],
