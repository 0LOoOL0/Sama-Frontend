...
export class VetClinicsComponent implements OnInit {
  ...
  providerId: any;
  heroHeading: string = "Paws & Claws Services";
  heroText = "Sama Pet Care offers everything your pet needs! From veterinary clinics, grooming, training, and pet sitting to a wide <br> range of quality pet products, find it all in one place. Easily locate nearby services and shops across Bahrain. <br> Pet care made easy!";
  ...
  viewProvider(providerId: number) {
    // Set the provider id in your service
    this.providerServicess.setProviderId(providerId);
    // Navigate to the provider details page (or product page) for that provider
    this.router.navigate(['/user-main-component/providers', providerId]);
  }
  ...
  sanitizeUrl(url: string): SafeUrl {
    ...
    console.log('Clean provider URL:', cleanUrl);
