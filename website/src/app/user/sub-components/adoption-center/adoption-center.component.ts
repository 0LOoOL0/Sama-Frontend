...
export class AdoptionCenterComponent {
  ...
  currentTitle: string = 'Adoption'; // Default title
  ...
  changeToMating() {
    this.direction = 3;
    this.currentTitle = 'Mating'; 
    this.heroHeadingText = 'Mating';
    this.mainText = `description about mating`;
    this.loadDirection(3);  // Show Mating pets
  }
